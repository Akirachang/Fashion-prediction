...
# matrix such that the matrix is:d
# 	num_samples x depth x rows x columns
# print(trainY)
# print(testY)

testList = getTestList()
testY = np.append(testY, testList)
print(trainX.shape) #(60000, 28, 28)
print(trainY.shape) #(60000,)
print(testX.shape)  #(10000, 28, 28)
print(testY.shape)  #(10000,)
...
for i in range(1):
	...
	probs = model.predict(imageTests())
